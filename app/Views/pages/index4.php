										...
										<div class="table-responsive">
											<table class="table table-vcenter text-nowrap mb-0 border">
												...
												<tbody>
													<tr>
														<td class="d-flex">
															<img class="avatar-lg rounded-circle mr-3" src="<?php echo base_url('public/assets/images/users/1.jpg'); ?>" alt="Image description">
															<div class="ml-3 mt-2">
													...
													<tr>
														<td class="d-flex">
															<img class="avatar-lg rounded-circle mr-3" src="<?php echo base_url('public/assets/images/users/2.jpg'); ?>" alt="Image description">
															<div class="ml-3 mt-2">
													...
													<tr>
														<td class="d-flex">
															<img class="avatar-lg rounded-circle mr-3" src="<?php echo base_url('public/assets/images/users/3.jpg'); ?>" alt="Image description">
															<div class="ml-3 mt-2">
													...
													<tr>
														<td class="d-flex">
															<img class="avatar-lg rounded-circle mr-3" src="<?php echo base_url('public/assets/images/users/4.jpg'); ?>" alt="Image description">
															<div class="ml-3 mt-2">
													...
													<tr>
														<td class="d-flex">
															<img class="avatar-lg rounded-circle mr-3" src="<?php echo base_url('public/assets/images/users/5.jpg'); ?>" alt="Image description">
															<div class="ml-3 mt-2">
													...
													<tr>
														<td class="d-flex">
															<img class="avatar-lg rounded-circle mr-3" src="<?php echo base_url('public/assets/images/users/6.jpg'); ?>" alt="Image description">
															<div class="ml-3 mt-2">
													...
													<tr>
														<td class="d-flex">
															<img class="avatar-lg rounded-circle mr-3" src="<?php echo base_url('public/assets/images/users/7.jpg'); ?>" alt="Image description">
															<div class="ml-3 mt-2">
...
<?= $this->include('layout/footer'); ?>
		...
		<script src="<?php echo base_url('public/assets/plugins/chartjs/chart.js'); ?>"></script>

		<!-- Index js-->
		<script src="<?php echo base_url('public/assets/js/index4.js'); ?>"></script>
		<!-- INTERNAL JS END -->
	</body>
</html>