													...
													<div class="d-flex order-lg-2 ml-auto">
														...
														<div class="dropdown d-none d-md-flex mt-1">
															...
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
																...
																<a href="#" class="dropdown-item d-flex pb-3">
																	<span class="avatar brround mr-3 align-self-center" style="background-image: url(<?php echo base_url('public/assets/images/users/4.jpg'); ?>)"></span>
																	<div>
																...
																<a href="#" class="dropdown-item d-flex pb-3">
																	<span class="avatar brround mr-3 align-self-center" style="background-image: url(<?php echo base_url('public/assets/images/users/1.jpg'); ?>)"></span>
																	<div>
																...
																<a href="#" class="dropdown-item d-flex pb-3">
																	<span class="avatar brround mr-3 align-self-center" style="background-image: url(<?php echo base_url('public/assets/images/users/8.jpg'); ?>)"></span>
																	<div>
														...
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
																...
																<a class="dropdown-item" href="<?php echo base_url('pages/login'); ?>">
									...
									<div class="">
										<div class="header py-4 bg-primary br-bl-7 br-br-7">
											<div class="container">
												<div class="d-flex">
													<a class="header-brand" href="<?php echo base_url('pages/index'); ?>">
														<img src="<?php echo base_url('public/assets/images/brand/logo1.png'); ?>" class="header-brand-img desktop-lgo" alt="Rygel Dash logo">
														<img src="<?php echo base_url('public/assets/images/brand/logo1.png'); ?>" class="header-brand-img dark-logo" alt="Rygel Dash logo">
														<img src="<?php echo base_url('public/assets/images/brand/favicon.png'); ?>" class="header-brand-img mobile-logo" alt="Rygel Dash logo">
														<img src="<?php echo base_url('public/assets/images/brand/favicon1.png'); ?>" class="header-brand-img darkmobile-logo" alt="Rygel Dash logo">
													</a>
