							...
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="tags">
											<span class="tag">
												<span class="tag-avatar avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/6.jpg'); ?>)"></span>
												Victoria
											</span>
											<span class="tag">
												<span class="tag-avatar avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/14.jpg'); ?>)"></span>
												Nathan
											</span>
											<span class="tag">
												<span class="tag-avatar avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/1.jpg'); ?>)"></span>
												Alice
											</span>
											<span class="tag">
												<span class="tag-avatar avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/4.jpg'); ?>)"></span>
												Rose
											</span>
											<span class="tag">
												<span class="tag-avatar avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/9.jpg'); ?>)"></span>
												Peter
											</span>
											<span class="tag">
												<span class="tag-avatar avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/12.jpg'); ?>)"></span>
												Wayne
											</span>
											<span class="tag">
												<span class="tag-avatar avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/7.jpg'); ?>)"></span>
												Michelle
											</span>
											<span class="tag">
												<span class="tag-avatar avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/11.jpg'); ?>)"></span>
												Debra
											</span>
										</div>
									</div>
