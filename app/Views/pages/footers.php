...
<?= $this->include('layout/menu'); ?>
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title">Footers</h4>
							</div>
											...
											<div class="container">
												<div class="row align-items-center">
													...
													<div class="col-lg-6 col-sm-12 col-md-7 mt-3 mt-lg-0 text-md-right">
														Copyright © 2020 <a href="#">Rygel Dash</a>.All rights reserved.
													</div>
												</div>
											</div>
										</div>
										...
										<div class="footer br-bl-7 br-br-7 border-top-0 p-0">
											<div class="">
												...
												<div class="row align-items-center flex-row-reverse border-top">
													<div class="col-lg-12 col-sm-12 mt-lg-0 text-center p-3 bg-light">
														Copyright © 2020 <a href="#">Rygel Dash</a>. Deployed by <a href="#">Rygel Technology Solutions</a> All rights reserved.
													</div>
												</div>
											</div>
												...
												<div class="p-4">
													<div class="row align-items-center">
														<div class="col-lg-6 col-md-6 d-md-block ">
															Copyright © 2020 <a href="#">Rygel Dash</a>.
														</div>
														<div class="col-lg-6 col-md-6 text-right privacy">
															<a href="#" class="btn btn-link" >Privacy</a>
															<a href="#" class="btn btn-link" >Terms</a>
