												...
												<table class="table" id="example1">
													<tbody>
														...
														<tr>
															...
															<td class="align-middle">
																<div class="d-flex">
																	<img src="<?php echo base_url('public/assets/images/files/folder.png'); ?>" alt="img" class="w-5 h-5 mr-2">
																	<div class="mt-1">
																		Images
																	</div>
																</div>
														...
														<tr>
															...
															<td class="align-middle">
																<div class="d-flex">
																	<img src="<?php echo base_url('public/assets/images/photos/1.jpg'); ?>" alt="img" class="w-5 h-5 mr-2 br-3">
																	<div class="mt-1">
																		Image
																	</div>
																</div>
														...
														<tr>
															...
															<td class="align-middle">
																<div class="d-flex">
																	<img src="<?php echo base_url('public/assets/images/files/word.png'); ?>" alt="img" class="w-5 h-5 mr-2">
																	<div class="mt-1">
																		Word Document
																	</div>
																</div>
