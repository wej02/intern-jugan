								...
								<div class="row">
									...
									<div class="col-xl-3 col-lg-6 col-sm-6">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center">
													<img src="<?php echo base_url('public/assets/images/products/2.jpg'); ?>" alt="img" class="img-fluid w-100">
												</div>
												<div class="card-body px-0 ">
													<div class="cardtitle">
														<div>
									...
									<div class="col-xl-3 col-lg-6 col-sm-6">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center">
													<img src="<?php echo base_url('public/assets/images/products/4.jpg'); ?>" alt="img" class="img-fluid w-100">
												</div>
												<div class="card-body px-0 ">
													<div class="cardtitle">
														<div>
									...
									<div class="col-xl-3 col-lg-6 col-sm-6">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center">
													<img src="<?php echo base_url('public/assets/images/products/8.jpg'); ?>" alt="img" class="img-fluid w-100">
												</div>
												<div class="card-body px-0 ">
													<div class="cardtitle">
														<div>
									...
									<div class="col-xl-3 col-lg-6 col-sm-6">
										<div class="card item-card ">
											<div class="card-body pb-0">
												<div class="text-center">
													<img src="<?php echo base_url('public/assets/images/products/3.jpg'); ?>" alt="img" class="img-fluid w-100">
												</div>
												<div class="card-body px-0 ">
													<div class="cardtitle">
														<div>
									...
									<div class="col-xl-3 col-lg-6 col-sm-6">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center">
													<img src="<?php echo base_url('public/assets/images/products/5.jpg'); ?>" alt="img" class="img-fluid w-100">
												</div>
												<div class="card-body px-0 ">
													<div class="cardtitle">
														<div>
