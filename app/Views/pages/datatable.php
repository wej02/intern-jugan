						...
						<div class="row">
							<div class="col-12">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="table-responsive">
											<button id="button" class="btn btn-primary btn-sm mb-4 data-table-btn">Delete selected row</button>
																		...
																		<div class="tab-content">
																			...
																			<div class="tab-pane" id="tab15">
																				<div class="p-4 bg-light">
																					To view stock deduction details tie your storage to the location in the tab Access → Locations.
																				</div>
																			</div>
																		</div>
																	</div>
