							...
							<div class="col-xl-4 col-md-12 col-lg-12">
								<div class="card bg-primary text-white">
									<div class="card-body text-center">
										<img class="avatar avatar-xxl brround mb-5" src="<?php echo base_url('public/assets/images/users/16.jpg'); ?>" alt="img">
							...
							<div class="col-lg-12 col-xl-4 col-sm-12">
								<div class="card  mb-5">
									<div class="card-body">
										<div class="media mt-0">
											<figure class="rounded-circle align-self-start mb-0">
												<img src="<?php echo base_url('public/assets/images/users/1.jpg'); ?>" alt="Generic placeholder image" class="avatar brround avatar-md mr-3">
											</figure>
									...
									<div class="card-footer text-secondary border-top">
										Email: <span class="text-primary">victoriacott@rygel.biz</span>
									</div>
								</div>
							</div>
							<div class="col-lg-12 col-xl-4 col-sm-12">
								<div class="card mb-5">
									<div class="card-body">
										<div class="media mt-0">
											<figure class="rounded-circle align-self-start mb-0">
												<img src="<?php echo base_url('public/assets/images/users/16.jpg'); ?>" alt="Generic placeholder image" class="avatar brround avatar-md mr-3">
											</figure>
											<div class="media-body">
									...
									<div class="card-footer text-secondary border-top">
										Email: <span class="text-primary">thomasjaim@rygel.biz</span>
									</div>
								</div>
							</div>
							<div class="col-lg-12 col-xl-4 col-sm-12">
								<div class="card mb-5">
									<div class="card-body">
										<div class="media mt-0">
											<figure class="rounded-circle align-self-start mb-0">
												<img src="<?php echo base_url('public/assets/images/users/3.jpg'); ?>" alt="Generic placeholder image" class="avatar brround avatar-md mr-3">
											</figure>
											<div class="media-body">
									...
									<div class="card-footer text-secondary border-top">
										Email: <span class="text-primary">rebbacawisely@rygel.biz</span>
									</div>
								</div>
							</div>
						</div>
											...
											<div class="row img-gallery">
												<div class="col-3">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid rounded" src="<?php echo base_url('public/assets/images/photos/1.jpg'); ?>" alt="">
												...
												<div class="col-3">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid rounded" src="<?php echo base_url('public/assets/images/photos/2.jpg'); ?>" alt="">
														<span class="link-overlay-bg rounded">
															<i class="fa fa-search"></i>
														</span>
													</a>
												...
												<div class="col-3">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid rounded" src="<?php echo base_url('public/assets/images/photos/3.jpg'); ?>" alt="">
														<span class="link-overlay-bg rounded">
															<i class="fa fa-search"></i>
														</span>
													</a>
												...
												<div class="col-3">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid rounded" src="<?php echo base_url('public/assets/images/photos/4.jpg'); ?>" alt="">
														<span class="link-overlay-bg rounded">
															<i class="fa fa-search"></i>
														</span>
													</a>
												...
												<div class="col-3">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid rounded" src="<?php echo base_url('public/assets/images/photos/5.jpg'); ?>" alt="">
														<span class="link-overlay-bg rounded">
															<i class="fa fa-search"></i>
														</span>
													</a>
												...
												<div class="col-3">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid rounded" src="<?php echo base_url('public/assets/images/photos/6.jpg'); ?>" alt="">
														<span class="link-overlay-bg rounded">
															<i class="fa fa-search"></i>
														</span>
													</a>
