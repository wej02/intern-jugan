<?= $this->extend('layout/layout-versions/sidemenu-closed-light-layout'); ?>
											...
											<div class="table-responsive">
												<table class="table transaction-table mb-0">
													<tbody>
														...
														<tr>
															<td class="d-flex">
																<img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/users/4.jpg'); ?>" alt="med																<div class="mt-2">ia1">
