							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img px-4 pt-4">
										<a href="#"></a>
										<img src="<?php echo base_url('public/assets/images/photos/blog.jpg'); ?>" alt="img" class="cover-image br-7 w-100">
									</div>
									<div class="card-body">
									...
									<div class="card-body">
										<div class="d-sm-flex mt-0 p-5 sub-review-section border border-bottom-0 br-bl-0 br-br-0">
											<div class="d-flex mr-3">
												<a href="#"><img class="media-object brround avatar-md" alt="64x64" src="<?php echo base_url('public/assets/images/users/1.jpg'); ?>"> </a>
											</div>
										...
										<div class="d-sm-flex p-5 sub-review-section border subsection-color br-tl-0 br-tr-0">
											<div class="d-flex mr-3">
												<a href="#"><img class="media-object brround avatar-md" alt="64x64" src="<?php echo base_url('public/assets/images/users/2.jpg'); ?>"> </a>
											</div>
											<div class="media-body">
										...
										<div class="d-sm-flex p-5 mt-4 border sub-review-section">
											<div class="d-flex mr-3">
												<a href="#"><img class="media-object brround avatar-md" alt="64x64" src="<?php echo base_url('public/assets/images/users/3.jpg'); ?>"> </a>
											</div>
											<div class="media-body">
