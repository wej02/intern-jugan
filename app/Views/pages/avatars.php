								...
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list">
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/1.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/1.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/3.jpg'); ?>)"></span>
										</div>
									</div>
...
<!---Prism Pre code-->
							...
							<div class="col-md-12 col-xl-6 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list">
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/1.jpg'); ?>)"></span>
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)"></span>
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/1.jpg'); ?>)"></span>
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)"></span>
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/3.jpg'); ?>)"></span>
										</div>
									</div>
									<div class="html-code"><svg class="svg-icon mr-2" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg> Html </div>
									<!---Prism Pre code-->
...
<!---Prism Pre code-->
							...
							<div class="col-md-12 col-xl-6 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list">
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/1.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/1.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/3.jpg'); ?>)"></span>
										</div>
									</div>
									<div class="html-code"><svg class="svg-icon mr-2" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg> Html </div>
									<!---Prism Pre code-->
...
<!---Prism Pre code-->
							...
							<div class="col-md-12 col-xl-6 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list">
											<span class="avatar avatar-sm" style="background-image: url(<?php echo base_url('public/assets/images/users/4.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/3.jpg'); ?>)"></span>
											<span class="avatar avatar-md" style="background-image: url(<?php echo base_url('public/assets/images/users/5.jpg'); ?>)"></span>
											<span class="avatar avatar-lg" style="background-image: url(<?php echo base_url('public/assets/images/users/6.jpg'); ?>)"></span>
											<span class="avatar avatar-xl" style="background-image: url(<?php echo base_url('public/assets/images/users/4.jpg'); ?>)"></span>
											<span class="avatar avatar-xxl" style="background-image: url(<?php echo base_url('public/assets/images/users/7.jpg'); ?>)"></span>
										</div>
									</div>
									<div class="html-code"><svg class="svg-icon mr-2" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg> Html </div>
									<!---Prism Pre code-->
...
<!---Prism Pre code-->
							...
							<div class="col-md-12 col-xl-6 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list">
											<span class="avatar avatar-sm brround" style="background-image: url(<?php echo base_url('public/assets/images/users/15.jpg'); ?>)"></span>
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/13.jpg'); ?>)"></span>
											<span class="avatar avatar-md brround" style="background-image: url(<?php echo base_url('public/assets/images/users/16.jpg'); ?>)"></span>
											<span class="avatar avatar-lg brround" style="background-image: url(<?php echo base_url('public/assets/images/users/7.jpg'); ?>)"></span>
											<span class="avatar avatar-xl brround" style="background-image: url(<?php echo base_url('public/assets/images/users/14.jpg'); ?>)"></span>
											<span class="avatar avatar-xxl brround" style="background-image: url(<?php echo base_url('public/assets/images/users/8.jpg'); ?>)"></span>
										</div>
									</div>
									<div class="html-code"><svg class="svg-icon mr-2" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg> Html </div>
									<!---Prism Pre code-->
...
<!---Prism Pre code-->
							...
							<div class="col-md-12 col-xl-6 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list">
											<span class="avatar avatar-sm bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/15.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/13.jpg'); ?>)"></span>
											<span class="avatar avatar-md bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/16.jpg'); ?>)"></span>
											<span class="avatar avatar-lg bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/7.jpg'); ?>)"></span>
											<span class="avatar avatar-xl bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/14.jpg'); ?>)"></span>
											<span class="avatar avatar-xxl bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/8.jpg'); ?>)"></span>
										</div>
									</div>
									<div class="html-code"><svg class="svg-icon mr-2" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg> Html </div>
									<!---Prism Pre code-->
...
<!---Prism Pre code-->
							...
							<div class="col-md-12 col-xl-6 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list">
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/8.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/5.jpg'); ?>)">
												<span class="avatar-status"></span>
											</span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/9.jpg'); ?>)">
												<span class="avatar-status bg-red"></span>
											</span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/6.jpg'); ?>)">
												<span class="avatar-status bg-green"></span>
											</span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/7.jpg'); ?>)">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list">
											...
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/15.jpg'); ?>)">
												<span class="avatar-status"></span>
											</span>
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)">
												<span class="avatar-status bg-red"></span>
											</span>
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/16.jpg'); ?>)">
												<span class="avatar-status bg-green"></span>
											</span>
											<span class="avatar brround" style="background-image: url(<?php echo base_url('public/assets/images/users/7.jpg'); ?>)">
												<span class="avatar-status bg-yellow"></span>
											</span>
										</div>
									</div>
...
<!---Prism Pre code-->
							...
							<div class="col-md-12 col-xl-6 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list">
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/9.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/15.jpg'); ?>)">
												<span class="avatar-status"></span>
											</span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)">
												<span class="avatar-status bg-red"></span>
											</span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/16.jpg'); ?>)">
												<span class="avatar-status bg-green"></span>
											</span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/7.jpg'); ?>)">
												<span class="avatar-status bg-yellow"></span>
											</span>
										</div>
									</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list avatar-list-stacked">
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/10.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/8.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/9.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/10.jpg'); ?>)"></span>
											<span class="avatar" style="background-image: url(<?php echo base_url('public/assets/images/users/11.jpg'); ?>)"></span>
...
<!---Prism Pre code-->
							...
							<div class="col-md-12 col-xl-6 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="avatar-list avatar-list-stacked">
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/12.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/9.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/2.jpg'); ?>)"></span>
											<span class="avatar bradius" style="background-image: url(<?php echo base_url('public/assets/images/users/4.jpg'); ?>)"></span>
