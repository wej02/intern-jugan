						...
						<div class="row">
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
									<img  src="<?php echo base_url('public/assets/images/photos/2.jpg'); ?>" alt="image" class="img-height">
									<div class="card-body">
							...
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
									...
									<img  src="<?php echo base_url('public/assets/images/photos/1.jpg'); ?>" alt="image" class="img-height">
								</div>
							</div>
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
									<img  src="<?php echo base_url('public/assets/images/photos/5.jpg'); ?>" alt="image" class="img-height">
									<div class="card-body">
										<h5 class="card-title mb-3">Card title</h5>
										<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
							...
							<div class="col-md-6 col-lg-4">
								<div class="card">
									...
									<img  src="<?php echo base_url('public/assets/images/photos/6.jpg'); ?>" alt="image" class="img-height">
									<div class="card-body">
										<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
								</div>
							...
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
									<img  src="<?php echo base_url('public/assets/images/photos/10.jpg'); ?>" alt="image" class="img-height">
									<div class="card-body">
							...
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
								<img  src="<?php echo base_url('public/assets/images/photos/8.jpg'); ?>" alt="image" class="img-height">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
							...
							<div class="col-md-12 col-xl-6">
								<div class="card card-aside">
									...
									<a href="#" class="card-aside-column br-tr-7 br-br-7 w-50" style="background-image: url(<?php echo base_url('public/assets/images/photos/2.jpg'); ?>)"></a>
								</div>
							</div>
							<div class="col-md-12 col-xl-6">
								<div class="card card-aside bg-primary">
									...
									<a href="#" class="card-aside-column br-tr-7 br-br-7 w-50" style="background-image: url(<?php echo base_url('public/assets/images/photos/20.jpg'); ?>)"></a>
								</div>
							</div>
							<div class="col-md-12 col-lg-6">
								<div class="card ">
									...
									<div class="card-body text-center">
										<img src="<?php echo base_url('public/assets/images/users/16.jpg'); ?>" class="avatar avatar-xxl brround" alt="">
							...
							<div class="col-md-12 col-lg-6">
								<div class="card ">
									...
									<div class="card-body text-center">
										<img src="<?php echo base_url('public/assets/images/users/10.jpg'); ?>" class="avatar avatar-xxl brround" alt="">
						...
						<div class="card">
							...
							<div class="card-group p-5">
								<div class="card shadow-none border border-right-0 overflow-hidden">
									<img  src="<?php echo base_url('public/assets/images/photos/10.jpg'); ?>" alt="image">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
										<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
								...
								<div class="card shadow-none border border-right-0 overflow-hidden">
									<img  src="<?php echo base_url('public/assets/images/photos/11.jpg'); ?>" alt="image">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
								...
								<div class="card shadow-none border overflow-hidden">
									<img  src="<?php echo base_url('public/assets/images/photos/12.jpg'); ?>" alt="image" class="img-height1">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
						...
						<div class="card">
							...
							<div class="card-group p-5">
								<div class="card  overflow-hidden shadow-none border border-right-0">
									<img  src="<?php echo base_url('public/assets/images/photos/13.jpg'); ?>" alt="image">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
										<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
									</div>
								...
								<div class="card  overflow-hidden shadow-none border border-right-0">
									<img  src="<?php echo base_url('public/assets/images/photos/14.jpg'); ?>" alt="image">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
										<p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
									</div>
								...
								<div class="card overflow-hidden shadow-none border">
									<img  src="<?php echo base_url('public/assets/images/photos/15.jpg'); ?>" alt="image">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
										<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
									</div>
