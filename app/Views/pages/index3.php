							...
							<div class="col-xl-4 col-md-12 col-lg-12">
								<div class="card">
									...
									<div class="p-4 scrollbar h-330" id="scrollbar">
										<div class="activity">
											<img src="<?php echo base_url('public/assets/images/users/14.jpg'); ?>" alt="" class="img-activity shadow3 border-primary">
											...
											<img src="<?php echo base_url('public/assets/images/users/10.jpg'); ?>" alt="" class="img-activity shadow3 border-secondary">
											<div class="time-activity">
												<div class="item-activity">
											...
											<img src="<?php echo base_url('public/assets/images/users/4.jpg'); ?>" alt="" class="img-activity shadow3 border-success">
											<div class="time-activity">
												<div class="item-activity">
											...
											<img src="<?php echo base_url('public/assets/images/users/8.jpg'); ?>" alt="" class="img-activity shadow3 border-danger">
											<div class="time-activity">
												<div class="item-activity">
							...
							<div class="col-xl-4 col-md-12 col-lg-12">
								<div class="card overflow-hidden">
									...
									<div class="p-4 scrollbar2 h-330" id="scrollbar2">
										<div class="activity">
											<img src="<?php echo base_url('public/assets/images/users/4.jpg'); ?>" alt="" class="img-activity shadow3 border-primary">
											<div class="time-activity">
												<div class="item-activity">
											...
											<img src="<?php echo base_url('public/assets/images/users/2.jpg'); ?>" alt="" class="img-activity shadow3 border-secondary">
											<div class="time-activity">
												<div class="item-activity">
											...
											<img src="<?php echo base_url('public/assets/images/users/1.jpg'); ?>" alt="" class="img-activity shadow3 border-success">
											<div class="time-activity">
												<div class="item-activity">
											...
											<img src="<?php echo base_url('public/assets/images/users/3.jpg'); ?>" alt="" class="img-activity shadow3 border-danger">
											<div class="time-activity">
												<div class="item-activity">
...
<?= $this->include('/layout/footer'); ?>
		...
		<!-- Index js-->
		<script src="<?php echo base_url('public/assets/js/index3.js'); ?>"></script>
		<!-- INTERNAL JS  END -->
	</body>
</html>
