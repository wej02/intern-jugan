                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row text-center">
                                            <div class="col-md-12">
                                                <img src="<?php echo base_url('public/assets/images/photos/award.png'); ?>" alt="img" class="sales-img">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        <p class="mb-1">Today Revenue</p>
                                                        <h2 class="mb-0 font-weight-bold">$999k</h2>
                                                    </div>
                                                    <div class="col col-auto">
                                                        <div id="spark7"></div>
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        <p class="mb-1">Unique Visitors</p>
                                                        <h2 class="mb-0 font-weight-bold">3,789</h2>
                                                    </div>
                                                    <div class="col col-auto">
                                                        <div id="spark8"></div>
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        <p class="mb-1">Expenses</p>
                                                        <h2 class="mb-0 font-weight-bold">$4,743</h2>
                                                    </div>
                                                    <div class="col col-auto">
                                                        <div id="spark9"></div>
                                                    </div>
                        ...
                        <div class="row row-deck">
                                    ...
                                    <div class="card-body">
                                        <div class="scrollbar h-400" id="scrollbar">
                                            <div class="d-flex mb-5">
                                                <a href="#" class="mr-4">
                                                    <img class="w-8 h-8 rounded shadow" src="<?php echo base_url('public/assets/images/orders/1.jpg'); ?>" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="#" class="mr-4">
                                                    <img class="w-8 h-8 rounded shadow" src="<?php echo base_url('public/assets/images/orders/2.jpg'); ?>" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="#" class="mr-4">
                                                    <img class="w-8 h-8 rounded shadow" src="<?php echo base_url('public/assets/images/orders/3.jpg'); ?>" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="#" class="mr-4">
                                                    <img class="w-8 h-8 rounded shadow" src="<?php echo base_url('public/assets/images/orders/4.jpg'); ?>" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                                    <h5 class="mb-1 font-weight-semibold">Health Watch</h5>
                                                    <small class="text-muted">1,42,400 times</small>
                                                </div>
                                            </div>
                                            <div class="d-flex mb-5">
                                                <a href="#" class="mr-4">
                                                    <img class="w-8 h-8 rounded shadow" src="<?php echo base_url('public/assets/images/orders/5.jpg'); ?>" alt="media1">
                                                </a>
                                                <div class="mt-3">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card card-block">
                                    ...
                                    <div class="card-body">
                                        <div class="chart-container">
                                            <canvas id="weejay-leads" class="h-400 chart-dropshadow-primary"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="h-400 scrollbar2" id="scrollbar2">
                                            <div class="table-responsive">
                                                <table class="table transaction-table mb-0 text-nowrap">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/orders/7.jpg'); ?>" alt="media1"> New Book</td>
                                                            <td>#12323423</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/orders/8.jpg'); ?>" alt="media1"> New Bowl</td>
                                                            <td>#26762768</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/orders/9.jpg'); ?>" alt="media1"> Modal Car</td>
                                                            <td>#76273277</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge badge-primary badge-pill">Completed</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/orders/10.jpg'); ?>" alt="media1"> Headset</td>
                                                            <td>#67237267</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/orders/11.jpg'); ?>" alt="media1"> New Headset</td>
                                                            <td>#561527167</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge badge-danger badge-pill">Declined</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/orders/12.jpg'); ?>" alt="media1"> Watch</td>
                                                            <td>#12323423</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge badge-primary badge-pill">Completed</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/orders/13.jpg'); ?>" alt="media1"> Branded Shoes</td>
                                                            <td>#26762768</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge badge-warning badge-pill">Pending</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/orders/14.jpg'); ?>" alt="media1"> New Modal shoe</td>
                                                            <td>#12323423</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge badge-primary badge-pill">Completed</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/orders/5.jpg'); ?>" alt="media1"> Branded Shoes</td>
                                                            <td>#26762768</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge badge-warning badge-pill">Pending</span></td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table transaction-table mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/users/1.jpg'); ?>" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/users/4.jpg'); ?>" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/users/5.jpg'); ?>" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/users/2.jpg'); ?>" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/users/10.jpg'); ?>" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow mr-3" src="<?php echo base_url('public/assets/images/users/12.jpg'); ?>" alt="media1">
                                                                <div class="mt-2">
