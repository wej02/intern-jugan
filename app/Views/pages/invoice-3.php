																...
																<ul class="nav panel-tabs">
																	<li class="active">
																		<a class="d-flex" data-toggle="tab" href="#tab41" aria-expanded="true">
																			<img src="<?php echo base_url('public/assets/images/files/file.png'); ?>" alt="img" class="w-7 h-7 mr-4">
																			<div class="mt-1">
														...
														<div class="tab-pane active text-center" id="tab01">
															<div class="row my-7">
																<div class="my-8 col-md-9 d-block mx-auto">
																	<img src="<?php echo base_url('public/assets/images/files/file.png'); ?>" alt="img" class="w-30 mb-4">
...
<?= $this->include('layout/footer'); ?>
		<!-- INTERNAL JS START -->
		<!-- Invoice js-->
		<script src="<?php echo base_url('public/assets/js/invoice.js'); ?>"></script>
		<!-- INTERNAL JS END -->
	</body>
</html>
