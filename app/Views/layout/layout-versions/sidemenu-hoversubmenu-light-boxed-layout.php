...
<html lang="en" dir="ltr">
	<head>
		...
		<!--Sidemenu css -->
        <link id="theme" href="<?php echo base_url('public/assets/css/sidemenu3.css'); ?>" rel="stylesheet">
				...
				<div class="app-sidebar2">
					<div class="app-sidebar__logo">
						<a class="header-brand" href="<?php echo base_url('pages/index'); ?>">
							<img src="<?php echo base_url('public/assets/images/brand/logo.png'); ?>" class="header-brand-img desktop-lgo" alt="Covido logo">
							<img src="<?php echo base_url('public/assets/images/brand/logo1.png'); ?>" class="header-brand-img dark-logo" alt="Covido logo">
							<img src="<?php echo base_url('public/assets/images/brand/favicon.png'); ?>" class="header-brand-img mobile-logo" alt="Covido logo">
							<img src="<?php echo base_url('public/assets/images/brand/favicon1.png'); ?>" class="header-brand-img darkmobile-logo" alt="Covido logo">
						</a>
					</div>
				</div>
