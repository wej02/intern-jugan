...
<html lang="en" dir="ltr">
	<head>
		...
		<!--Sidemenu css -->
        <link id="theme" href="<?php echo base_url('public/assets/css/closed-sidemenu.css'); ?>" rel="stylesheet">
	...
	<body class="app sidebar-mini light-mode light-sidebar boxed">
...
<?= $this->renderSection('content'); ?>
		...
		<script src="<?php echo base_url('public/assets/plugins/jvectormap/jquery.vmap.sampledata.j'); ?>s"></script>
