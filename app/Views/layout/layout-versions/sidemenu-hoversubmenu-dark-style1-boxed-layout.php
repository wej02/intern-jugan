...
<html lang="en" dir="ltr">
	<head>
		...
		<!--Sidemenu css -->
        <link id="theme" href="<?php echo base_url('public/assets/css/sidemenu4.css'); ?>" rel="stylesheet">
				...
				<aside class="app-sidebar app-sidebar3">
					...
					<ul class="side-menu">
						<li class="slide">
							...
							<ul class="slide-menu">
								<li class="side-menu-label1"><a href="#"></a>Dashboard</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li class="side-menu-label1"><a href="#"></a>Layouts</li>
								<li class="sub-slide">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Apps</li>
								<li class="sub-slide">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Widgets</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Forms</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li class="side-menu-label1"><a href="#"></a>Charts</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Map</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Tables</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Elements</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Icons</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Pages</li>
								<li class="sub-slide">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>E-Commerce</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li class="side-menu-label1"><a href="#"></a>Basic Elements</li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Account</li>
								<li class="sub-slide">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Error Pages</li>
						...
						<li class="slide ">
							...
							<ul class="slide-menu">
							<li class="side-menu-label1"><a href="#"></a>Submenus</li>
								<li class="sub-slide">
