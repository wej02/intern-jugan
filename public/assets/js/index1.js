$(function(e){
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: "Sales",
                data: [253, 256, 395, 204, 251, 458, 364, 145, 156, 250, 253],
                backgroundColor: 'rgba(68, 84, 195,0.1)',
                borderColor: 'rgba(68, 84, 195,0.9)',
                borderWidth: 5,
                pointStyle: 'circle',
    ...
    var spark4 = {
      ...
      var sparklineData7 = [0, 23, 45, 78, 55, 13, 63, 31, 97, 14, 53, 29, 66, 75, 52, 18, 66, 84, 55, 11, 87, 59, 22, 91];
      ...
      var spark7 = {
        ...
        series: [{
          name: 'New Expenses',
          data: randomizeArray(sparklineData7)
        }],
        yaxis: {
          min: 0
        },
      ...
      var sparklineData8 = Array.from({ length: 40 }, () => Math.floor(Math.random() * 101));
      ...
      var spark8 = {
        ...
        series: [{
          name: 'New Expenses',
          data: randomizeArray(sparklineData8)
        }],
        yaxis: {
          min: 0
        },
      ...
      var sparklineData9 = [0, 23, 45, 78, 55, 13, 63, 31, 97, 14, 53, 29, 66, 75, 52, 18, 66, 84, 55, 11, 87, 59, 22, 91];
      ...
      var spark9 = new ApexCharts(document.querySelector("#spark9"), spark9);
      spark9.render();
